...
import ru.philit.ufs.model.converter.esb.asfs.AsfsAdapterBaseTest;
...
public class CashOrderMapperTest extends AsfsAdapterBaseTest {
  ...
  @Before
  public void setUp() {
    cashOrderMapper = new CashOrderMapperImpl();
  ...
  public void testRequestCreateCashOrder() {
    SrvCreateCashOrderRq request = cashOrderMapper.requestCreateCashOrder(cashOrder);
  ...
  public void testRequestUpdStCashOrder() {
    SrvUpdStCashOrderRq request = cashOrderMapper.requestUpdStCashOrder(cashOrder);
    assertHeaderInfo(request.getHeaderInfo());
  ...
  public void testConvertSrvCreateCashOrderRs() {
    CashOrder testCashOrder = cashOrderMapper.convert(createCashOrderRs);
  ...
  public void testConvertSrvUpdStCashOrderRs() {
    CashOrder testCashOrder = cashOrderMapper.convert(updStCashOrderRs);
    assertHeaderInfo(testCashOrder, FIX_UUID);
