...
public class CheckOverLimitMapperTest extends AsfsAdapterBaseTest {
  ...
  private CheckOverLimitMapper checkOverLimitMapper;
  ...
  @Before
  public void setUp() {
    checkOverLimitMapper = new CheckOverLimitMapperImpl();
  ...
  public void testRequestCheckOverLimit() {
    SrvCheckOverLimitRq request = checkOverLimitMapper
  ...
  public void testConvertSrvCheckOverLimitRs() {
    ExternalEntityContainer<Boolean> container = checkOverLimitMapper.convert(checkOverLimitRs);
